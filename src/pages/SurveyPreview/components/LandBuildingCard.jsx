...
export default function LandBuildingCard({ data, onUpdate }) {
  ...
  const fields = [
    { key: "plot_area", label: "Plot Area (Sq. Ft.)", type: "number" },
    { key: "plinth_area", label: "Plinth Area", type: "number" },
    {
    ...
    >
      ...
      >
        ...
        <Box sx={{ mt: 2 }}>
          ...
          <FloorDetailsTable
            floors={formData.floor_details || data.floor_details || []}
            isEditing={isEditing}
            onFloorUpdate={(updatedFloors) => {
              setFormData((prev) => ({
                ...prev,
