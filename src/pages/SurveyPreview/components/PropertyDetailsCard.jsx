...
export default function PropertyDetailsCard({ data, onUpdate }) {
  ...
  const fields = [
    { key: 'property_status', label: 'Property Status', type: 'text' },
    { key: 'building_permission_available', label: 'Building Permission Available', type: 'text' },
    { key: 'property_ownership', label: 'Property Ownership', type: 'text' },
  ];
