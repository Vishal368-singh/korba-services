...
import { Box, Button, Typography, Paper, useMediaQuery, useTheme, Grid, IconButton, Chip } from '@mui/material';
import { Edit, Save, Cancel, CheckCircle, Cancel as CancelIcon, OpenInNew, CloudUpload, Delete } from '@mui/icons-material';
...
export default function DocumentsCard({ data, onUpdate }) {
  ...
  const documents = [
    { key: 'aadhaar_copy', title: 'Aadhaar Copy', filesKey: 'aadhaar_copy_files' },
    { key: 'electricity_bill', title: 'Electricity Bill', filesKey: 'electricity_bill_files' },
    { key: 'water_bill', title: 'Water Bill', filesKey: 'water_bill_files' },
    { key: 'sale_deed', title: 'Sale Deed', filesKey: 'sale_deed_files' },
    { key: 'property_tax_receipt', title: 'Property Tax Receipt', filesKey: 'property_tax_receipt_files' },
    { key: 'building_permission', title: 'Building Permission', filesKey: 'building_permission_files' },
    { key: 'other_documents', title: 'Other Documents', filesKey: 'other_documents_files' },
  ];
                ...
                <Paper
                  sx={{
                    ...
                    '&:hover': {
                      ...
                      boxShadow: isEditing ? '0 2px 8px rgba(122, 20, 83, 0.1)' : 'none',
                    },
                  }}
                >
                  {/* Document Header */}
