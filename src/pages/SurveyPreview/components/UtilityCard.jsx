...
export default function UtilityCard({ data, onUpdate }) {
  ...
  const fields = [
    { key: 'sewer_connection', label: 'Sewer Connection', type: 'text' },
    { key: 'is_electricity_connection', label: 'Electricity Connection', type: 'text' },
    { key: 'gas_connection', label: 'Gas Connection', type: 'text' },
  ];
